...
**mingzzzi333/mingzzzi333** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
<tbody>
<tr><td>프로젝트명</td>
<td><a href="https://app.notion.com/p/Linea-AI-391b897624f983059826815fd9606448?source=copy_link">📄 AI 기반 제조 생산 일정 자동화 플랫폼</a></td></tr>
<tr><td>기간 / 인원</td>
<td>2026.06 ~ 2026.07 (30일) · 3인 팀 프로젝트</td></tr>
<tr><td>개요</td>
<td>국내 GDP의 28%를 차지하는 제조업, 그 양산 일정을 GPT가 짜준다면? AI가 생산 일정을 자동으로 생성하고 설비를 관리하며, GPT 챗봇과 문서 업로드를 통해 현장 업무를 지원하는 플랫폼입니다.</td></tr>
<tr><td>주요 기술</td>
...
### INVEST YATRA — 실시간 주식 데이터 정보 제공 서비스

`2025.05 ~ 2025.06 (37일) · 3인 팀 프로젝트`

실시간 주가 데이터를 기반으로 시장 트렌드에 맞춘 주제 중심의 주식 추천 플랫폼으로, 초보자도 쉽게 이해할 수 있는 형태로 정보를 제공합니다.

**Core Features**

- 데이터 Table ERD 설계 및 회원·관리자 로그인/권한 분리 구현
- Kafka와 WebSocket을 활용한 실시간 주식 데이터 연동
- Chart.js 기반 실시간 주가 차트 시각화
- 커뮤니티 게시판(게시글 CRUD), 회원 ↔ 관리자 1:1 문의 서비스 구현

`Java · Spring Boot · JSP · MyBatis · Oracle · Kafka · WebSocket · Chart.js`

📄 https://app.notion.com/p/INVEST-YATRA-38db897624f9807699bffe3f0854c297?source=copy_link
